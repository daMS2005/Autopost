...
start_time = 0
end_time = tts.get_audio_length("output_0.mp3")
cut_video = copy_path.subclip(start_time, end_time)
cut_video_with_audio = cut_video.set_audio(audio)
cut_video_with_audio.write_videofile(fr"C:\Users\Daniel Mora\Documents\Autopost\cut_video_with_audio{0}.mp4", codec='libx264', audio_codec='aac')
